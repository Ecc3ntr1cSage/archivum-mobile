...
DATABASE SCHEMA (Supabase / PostgreSQL):
  ...
  transaction_splits (id bigint, transaction_id bigint, tag_id bigint, amount int [cents], created_at timestamptz)
  budgets      (id bigint, user_id uuid, tag_id bigint, currency text, limit_amount int [cents], period text, start_date date, end_date date, is_active bool, created_at timestamptz)
